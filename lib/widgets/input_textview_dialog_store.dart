...
class TextViewDialogStore extends StatefulWidget {
  const TextViewDialogStore({Key key, this.confirm}) : super(key: key);
  final Confirm confirm;

  @override
  State<StatefulWidget> createState() {
    return _TextViewDialogStoreState();
  }
}

class _TextViewDialogStoreState extends State<TextViewDialogStore> {
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        hintText: '商家名...', border: InputBorder.none),
                  ),
                ),
                Container(
