...
class TextViewDialogAccount extends StatefulWidget {
  const TextViewDialogAccount({Key key, this.confirm}) : super(key: key);
  final Confirm confirm;

  @override
  State<StatefulWidget> createState() {
    return _TextViewDialogAccountState();
  }
}

class _TextViewDialogAccountState extends State<TextViewDialogAccount> {
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        hintText: '账户名...', border: InputBorder.none),
                  ),
                ),
                Container(
