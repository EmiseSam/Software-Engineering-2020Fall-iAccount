...
class TextViewDialogProject extends StatefulWidget {
  const TextViewDialogProject({Key key, this.confirm}) : super(key: key);
  final Confirm confirm;

  @override
  State<StatefulWidget> createState() {
    return _TextViewDialogProjectState();
  }
}

class _TextViewDialogProjectState extends State<TextViewDialogProject> {
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        hintText: '项目名...', border: InputBorder.none),
                  ),
                ),
                Container(
