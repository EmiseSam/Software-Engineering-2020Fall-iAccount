...
class BillSearchListProjectWithtype extends StatefulWidget {
  BillSearchListProjectWithtype(this.accountName, this.type) : super();
  final accountName;
  final type;

  @override
  State<StatefulWidget> createState() {
    return BillSearchListProjectWithtypeState();
  }
}

class BillSearchListProjectWithtypeState
    extends State<BillSearchListProjectWithtype> {
  List _datas = List();
  String myYear1 = "1971";
  String myMonth1 = "01";
  String myYear2 = "2055";
  ...
  Future _initDatas() async {
    ...
    dbHelp
        .getBillListProjectWithType(startTime, endTime, widget.type,
      ...
      appBar: MyAppBar(
        titleWidget: Row(
          ...
          children: <Widget>[
            ...
            Text(
              widget.accountName == '' ? "未指定项目" : '${widget.accountName}',
            ),
            ButtonTheme(
              padding: const EdgeInsets.symmetric(horizontal: 0),
              child: FlatButton(
