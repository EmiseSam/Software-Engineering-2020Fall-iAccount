...
class BillSearchListProject extends StatefulWidget {
  BillSearchListProject(this.accountName) : super();
  final accountName;

  @override
  State<StatefulWidget> createState() {
    return BillSearchListProjectState();
  }
}

class BillSearchListProjectState extends State<BillSearchListProject> {
  List _datas = List();
  String myYear1 = "1971";
  String myMonth1 = "01";
  String myYear2 = "2055";
  ...
  Future _initDatas() async {
    ...
    dbHelp
        .getBillListProject(startTime, endTime, categoryName: widget.accountName)
        .then((models) {
      DateTime _preTime;
