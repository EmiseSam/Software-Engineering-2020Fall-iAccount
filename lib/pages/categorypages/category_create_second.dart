...
class _CategoryCreateSecondPageState extends State<CategoryCreateSecondPage> {
  TextEditingController _categoryName = new TextEditingController();
  var _typePickerData = ["支出分类", "收入分类"];
  var _categoryFirstPickerData = ["分类1", "分类2"];
  String _categoryFirstName = '';
          ...
          children: [
            ...
            Padding(
              ...
              child: HighLightWell(
                onTap: () {
                  MyPickerTool.showStringPicker(context,
                      data: _categoryFirstPickerData,
                      normalIndex: 0,
                      title: "请选择", clickCallBack: (int index, var str) {
                        setState(() {
                          _categoryFirstName = str;
                        });
                      });
                },
                borderRadius: BorderRadius.circular(10),
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5),
                      border: Border.all(color: Colours.gray, width: 0.6)),
                  child: Text(_categoryFirstName.isEmpty ? '请选择二级分类对应的一级分类' : _categoryFirstName),
                ),
              ),
            ),
          ],
