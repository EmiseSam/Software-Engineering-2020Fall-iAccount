...
class BillSearchListtAccountWithType extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return BillSearchListtAccountWithTypeState();
  }
}

class BillSearchListtAccountWithTypeState extends State<BillSearchListtAccountWithType> {
  List _datas = List();
  String myYear1 = "1971";
  String myMonth1 = "01";
  String myYear2 = "2055";
  ...
  Future _initDatas() async {
    ...
    dbHelp
        .getBillListAccountWithType(startTime, endTime, widget.type,
